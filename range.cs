...
namespace YomiChanPort
{
    internal class range
    {
        ...
        //    new KeyValuePair<char,string>(' ', "のノ" ) // this blank one is holding it back from all being char and below... annoying
        //    //{ '\0', "ぁあかがさざただなはばぱまゃやらゎわヵァアカガサザタダナハバパマャヤラヮワヵヷ" },
        //};
        List<Tuple<char, string>> VOWEL_TO_KANA_MAPPING = new()
        {
            ...
            new Tuple<char,string>(' ', "のノ" ) // this blank one is holding it back from all being char and below... annoying
            //{ '\0', "ぁあかがさざただなはばぱまゃやらゎわヵァアカガサザタダナハバパマャヤラヮワヵヷ" },
        };
